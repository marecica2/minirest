...
import org.bmsource.minirest.utils.CookieParser;
...
public class HttpHeadersImpl implements HttpHeaders {
	...
	public HttpHeadersImpl(MultivaluedMap<String, String> requestHeaders) {
		this(requestHeaders, new HashMap<String, Cookie>());
	}

	public HttpHeadersImpl(MultivaluedMap<String, String> requestHeaders, Map<String, Cookie> cookies) {
